...
@SourceType(value = "ApacheCouchDBARP", label = "ApacheCouchDB",uiConfig = "apachecouchdb-layout.json")
public class ApacheCouchDBConf extends AbstractArpConf<ApacheCouchDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/apachecouchdb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.apachecouchdb.ApacheCouchDBDriver";
